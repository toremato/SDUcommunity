...
<!--               Main Page                 -->
	...
	<div id="container">
		<div id="content">
			<div class="row">
				<div class="avatar-container span2 offset1"><div class="avatar"></div></div>
			...
			<div class="row">
				<div class="info span3">
					...
					<br>
						<div class="info-line">
							<p>Date of birth:</p>
							<p class="value">16.06.1995</p>
						</div>
						<div class="info-line">
							<p>City of birth:</p>
							<p class="value">Aktobe, Kazakhstan</p>
						</div>
						<div class="info-line">
							<p>City of residence:</p>
							<p class="value">Kaskelen, ALmaty</p>
						</div>
						<div class="info-line">
							<p>Nationality:</p>
							<p class="value">kazakh</p>
						</div>
				</div>
				<div class="info span3">
				<h2>Contacts</h2>
			...
			<div class="row">
				<div class="info span6">
					...
					<br>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus sit, eius cum dicta magnam, a, distinctio sint eveniet fugiat quae adipisci, ipsa laudantium consequatur! Voluptatum incidunt alias odio tempora, officia mollitia iste, pariatur perferendis facere illum consequatur vel. Illo fugiat veniam id itaque blanditiis eveniet, dolor ratione hic commodi! Possimus!</p>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate mollitia iste ut consequuntur blanditiis repudiandae adipisci, harum nisi doloremque tempora?</p>
				</div>
			</div>
